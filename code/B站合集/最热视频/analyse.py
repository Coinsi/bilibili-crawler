...
if __name__ == '__main__':
    df = pd.read_csv("入站必刷.csv")  # 打开文件，使用参数df接收所有数据
    ...
    bar1.set_global_opts(
        title_opts=opts.TitleOpts(title="b站必刷视频统计柱状图", pos_left="50%", pos_top="5%"),
